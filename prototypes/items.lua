...
combinator.icon = "__filter-combinator-updated__/graphics/icons/filter-combinator.png"

local alert = table.deepcopy(combinator)
alert.name = "signal-filter-combinator-alert"
alert.icon = "__filter-combinator-updated__/graphics/icons/overflow.png"
alert.icon_size = 64
