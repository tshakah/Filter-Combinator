...
local full_display_sprite = {
  north = {
    filename = "__filter-combinator-updated__/graphics/entities/filter-combinator-display.png",
    width = 15,
    height = 11,
    scale = main.and_symbol_sprites.north.scale,
    shift = main.and_symbol_sprites.north.shift,
    hr_version = {
      filename = "__filter-combinator-updated__/graphics/entities/hr-filter-combinator-display.png",
      width = 30,
      height = 22,
...
main.icon = "__filter-combinator-updated__/graphics/icons/filter-combinator.png"

local blank_sprite = {
  filename = "__filter-combinator-updated__/graphics/entities/blank.png",
  width = 1,
  height = 1,
  frame_count = 1,
  shift = {0, 0}
