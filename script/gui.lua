...
local function on_gui_opened(e)
  ...
  vertical_flow_1.add{type = "label", style = "heading_2_label", caption = {"gui.control-wire"}, tooltip = {
    "gui.control-wire-tooltip"}}
  ...
  vertical_flow_2.add{type = "label", style = "heading_2_label", caption = {"gui.filter-mode"}, tooltip = {
    "gui.filter-mode-tooltip"}}
